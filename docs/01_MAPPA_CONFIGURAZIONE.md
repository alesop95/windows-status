...
| `2026-09-15` | Software (progetto `retrogame-mod-pok-dev`) | Installato FlashGBX 5.1 (setup ufficiale, componente driver escluso) in `C:\Users\Utente\AppData\Local\Programs\FlashGBX`; driver CH340/CH341 arrivato da sé via Windows Update al collegamento del GBxCart RW, senza intervento manuale | Setup ufficiale `github.com/Lesserkuma/FlashGBX`, digest SHA-256 verificato prima dell'esecuzione | Serve la catena hardware-driver-software del sottoprogetto `gba-save-extraction-smeraldo`, oggi in convalida su una cartuccia di prova prima della cartuccia bersaglio | Disinstallare FlashGBX da "App installate"; il driver CH340/CH341 si rimuove da Gestione Dispositivi, ma è inoffensivo lasciarlo |
| `2026-09-23` | Software (progetto `retrogame-mod-pok-dev`) | Installato il .NET SDK 10.0.401 in `C:\Program Files\dotnet\sdk`; i runtime già presenti non cambiano | WinGet, `winget install Microsoft.DotNet.SDK.10`, lanciato dall'utente | compilare dal sorgente la libreria del verificatore di salvataggi Pokémon, che richiede `net10.0` | `winget uninstall Microsoft.DotNet.SDK.10` |
|              |             |                              |           |                 |                          |
