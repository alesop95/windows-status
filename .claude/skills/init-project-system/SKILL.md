...
2. Predisposizione del `.gitignore` con le esclusioni del livello privato: almeno `_notes/`, `CLAUDE.local.md`, `.claude/settings.local.json`, i `.docx` grezzi con eventuali eccezioni curate, e le cartelle scratch `.tmp-docx-*`.
